...
describe('Create Bowerman', () => {
    it('Correct create', () => {
        expect(new Bowerman('Mike')).toEqual({name: 'Mike', type: 'Bowman', health: 100, level: 1, _attack: 25, defence: 25})
    });
    ...
    it('Level up', () => {
        hero.levelUp()
        expect(hero).toEqual({name: 'Mike', type: 'Bowman', health: 100, level: 2, _attack: 30, defence: 30})
    });
